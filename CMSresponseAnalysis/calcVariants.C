void calcVariants()
{
  ...
  TFile* fzj_HCALp3 = TFile::Open("output_ROOT_files/CMSJES_P8_Zjet_5000000_varHCALp3.root");
  TFile* fzj_HCALm3 = TFile::Open("output_ROOT_files/CMSJES_P8_Zjet_5000000_varHCALm3.root");
  ...
  string outname = "./output_ROOT_files/varHCAL_5000000.root"; //Output file
  ...
  //TFile* fzj_HCALp3 = TFile::Open("output_ROOT_files/CMSJES_P8_Zjet_30000_varHCALp3.root");
  //TFile* fzj_HCALm3 = TFile::Open("output_ROOT_files/CMSJES_P8_Zjet_30000_varHCALm3.root");
  ...
  TProfile *pr_Rjet_HCALp3 = 0;
  TProfile *pr_Rjet_HCALm3 = 0;
  ...
  TProfile *pr_Rjetb_HCALp3 = 0;
  TProfile *pr_Rjetb_HCALm3 = 0;
  ...
  TProfile *pr_Rjetc_HCALp3 = 0;
  TProfile *pr_Rjetc_HCALm3 = 0;
  ...
  TProfile *pr_Rjets_HCALp3 = 0;
  TProfile *pr_Rjets_HCALm3 = 0;
  ...
  TProfile *pr_Rjetud_HCALp3 = 0;
  TProfile *pr_Rjetud_HCALm3 = 0;
  ...
  TProfile *pr_Rjetg_HCALp3 = 0;
  TProfile *pr_Rjetg_HCALm3 = 0;
  ...
  fzj_HCALp3->GetObject("prRjet", pr_Rjet_HCALp3);
  fzj_HCALm3->GetObject("prRjet", pr_Rjet_HCALm3);
  ...
  fzj_HCALp3->GetObject("prRjetb", pr_Rjetb_HCALp3);
  fzj_HCALm3->GetObject("prRjetb", pr_Rjetb_HCALm3);
  ...
  fzj_HCALp3->GetObject("prRjetc", pr_Rjetc_HCALp3);
  fzj_HCALm3->GetObject("prRjetc", pr_Rjetc_HCALm3);
  ...
  fzj_HCALp3->GetObject("prRjets", pr_Rjets_HCALp3);
  fzj_HCALm3->GetObject("prRjets", pr_Rjets_HCALm3);
  ...
  fzj_HCALp3->GetObject("prRjetud", pr_Rjetud_HCALp3);
  fzj_HCALm3->GetObject("prRjetud", pr_Rjetud_HCALm3);
  ...
  fzj_HCALp3->GetObject("prRjetg", pr_Rjetg_HCALp3);
  fzj_HCALm3->GetObject("prRjetg", pr_Rjetg_HCALm3);
  ...
  TH1D* h_Rjet_HCALp3 = pr_Rjet_HCALp3->ProjectionX();
  TH1D* h_Rjet_HCALm3 = pr_Rjet_HCALm3->ProjectionX();
  ...
  TH1D* h_Rjetb_HCALp3 = pr_Rjetb_HCALp3->ProjectionX();
  TH1D* h_Rjetb_HCALm3 = pr_Rjetb_HCALm3->ProjectionX();
  ...
  TH1D* h_Rjetc_HCALp3 = pr_Rjetc_HCALp3->ProjectionX();
  TH1D* h_Rjetc_HCALm3 = pr_Rjetc_HCALm3->ProjectionX();
  ...
  TH1D* h_Rjets_HCALp3 = pr_Rjets_HCALp3->ProjectionX();
  TH1D* h_Rjets_HCALm3 = pr_Rjets_HCALm3->ProjectionX();
  ...
  TH1D* h_Rjetud_HCALp3 = pr_Rjetud_HCALp3->ProjectionX();
  TH1D* h_Rjetud_HCALm3 = pr_Rjetud_HCALm3->ProjectionX();
  ...
  TH1D* h_Rjetg_HCALp3 = pr_Rjetg_HCALp3->ProjectionX();
  TH1D* h_Rjetg_HCALm3 = pr_Rjetg_HCALm3->ProjectionX();
  ...
  */
  ...
  h_Rjet_HCALp3->Divide(h_Rjet);
  h_Rjet_HCALp3->SetTitle("All jets, HCAL +3%");
  h_Rjet_HCALp3->GetYaxis()->SetTitle("R_{jet}^{var} / R_{jet}");
  h_Rjet_HCALp3->GetYaxis()->SetTitleOffset(1.2);
  h_Rjet_HCALm3->Divide(h_Rjet);
  h_Rjet_HCALm3->SetTitle("All jets, HCAL -3%");
  h_Rjet_HCALm3->GetYaxis()->SetTitle("R_{jet}^{var} / R_{jet}");
  h_Rjet_HCALm3->GetYaxis()->SetTitleOffset(1.2);
  ...
  */
  ...
  h_Rjetb_HCALp3->Divide(h_Rjetb);
  h_Rjetb_HCALp3->SetTitle("b-jets, HCAL +3%");
  h_Rjetb_HCALp3->GetYaxis()->SetTitle("R_{b-jet}^{var} / R_{b-jet}");
  h_Rjetb_HCALp3->GetYaxis()->SetTitleOffset(1.2);
  h_Rjetb_HCALm3->Divide(h_Rjetb);
  h_Rjetb_HCALm3->SetTitle("b-jets, HCAL -3%");
  h_Rjetb_HCALm3->GetYaxis()->SetTitle("R_{b-jet}^{var} / R_{b-jet}");
  h_Rjetb_HCALm3->GetYaxis()->SetTitleOffset(1.2);
  ...
  */
  ...
  h_Rjetc_HCALp3->Divide(h_Rjetc);
  h_Rjetc_HCALp3->SetTitle("c-jets, HCAL +3%");
  h_Rjetc_HCALp3->GetYaxis()->SetTitle("R_{c-jet}^{var} / R_{c-jet}");
  h_Rjetc_HCALp3->GetYaxis()->SetTitleOffset(1.2);
  h_Rjetc_HCALm3->Divide(h_Rjetc);
  h_Rjetc_HCALm3->SetTitle("c-jets, HCAL -3%");
  h_Rjetc_HCALm3->GetYaxis()->SetTitle("R_{c-jet}^{var} / R_{c-jet}");
  h_Rjetc_HCALm3->GetYaxis()->SetTitleOffset(1.2);
  ...
  */
  ...
  h_Rjets_HCALp3->Divide(h_Rjets);
  h_Rjets_HCALp3->SetTitle("s-jets, HCAL +3%");
  h_Rjets_HCALp3->GetYaxis()->SetTitle("R_{s-jet}^{var} / R_{s-jet}");
  h_Rjets_HCALp3->GetYaxis()->SetTitleOffset(1.2);
  h_Rjets_HCALm3->Divide(h_Rjets);
  h_Rjets_HCALm3->SetTitle("s-jets, HCAL -3%");
  h_Rjets_HCALm3->GetYaxis()->SetTitle("R_{s-jet}^{var} / R_{s-jet}");
  h_Rjets_HCALm3->GetYaxis()->SetTitleOffset(1.2);
  ...
  */
  ...
  h_Rjetud_HCALp3->Divide(h_Rjetud);
  h_Rjetud_HCALp3->SetTitle("ud-jets, HCAL +3%");
  h_Rjetud_HCALp3->GetYaxis()->SetTitle("R_{ud-jet}^{var} / R_{ud-jet}");
  h_Rjetud_HCALp3->GetYaxis()->SetTitleOffset(1.2);
  h_Rjetud_HCALm3->Divide(h_Rjetud);
  h_Rjetud_HCALm3->SetTitle("ud-jets, HCAL -3%");
  h_Rjetud_HCALm3->GetYaxis()->SetTitle("R_{ud-jet}^{var} / R_{ud-jet}");
  h_Rjetud_HCALm3->GetYaxis()->SetTitleOffset(1.2);
  ...
  */
  ...
  h_Rjetg_HCALp3->Divide(h_Rjetg);
  h_Rjetg_HCALp3->SetTitle("g-jets, HCAL +3%");
  h_Rjetg_HCALp3->GetYaxis()->SetTitle("R_{g-jet}^{var} / R_{g-jet}");
  h_Rjetg_HCALp3->GetYaxis()->SetTitleOffset(1.2);
  h_Rjetg_HCALm3->Divide(h_Rjetg);
  h_Rjetg_HCALm3->SetTitle("g-jets, HCAL -3%");
  h_Rjetg_HCALm3->GetYaxis()->SetTitle("R_{g-jet}^{var} / R_{g-jet}");
  h_Rjetg_HCALm3->GetYaxis()->SetTitleOffset(1.2);
  ...
  */
  ...
  h_Rjet_HCALm3->Write("h_Rjet_HCALm3");
  h_Rjet_HCALp3->Write("h_Rjet_HCALp3");
  ...
  h_Rjetb_HCALm3->Write("h_Rjetb_HCALm3");
  h_Rjetb_HCALp3->Write("h_Rjetb_HCALp3");
  ...
  h_Rjetc_HCALm3->Write("h_Rjetc_HCALm3");
  h_Rjetc_HCALp3->Write("h_Rjetc_HCALp3");
  ...
  h_Rjets_HCALm3->Write("h_Rjets_HCALm3");
  h_Rjets_HCALp3->Write("h_Rjets_HCALp3");
  ...
  h_Rjetud_HCALm3->Write("h_Rjetud_HCALm3");
  h_Rjetud_HCALp3->Write("h_Rjetud_HCALp3");
  ...
  h_Rjetg_HCALm3->Write("h_Rjetg_HCALm3");
  h_Rjetg_HCALp3->Write("h_Rjetg_HCALp3");
